...
public interface Constants {
    ...
    String PREF_SV_Boolean_Editing = "pref_sv_Shelf_Key-QnAE&4^j%6dMrs[4_Editing"; // Keep the id of the the stack or card that is being edited TODO MIGHT NEED TO HAVE SEPERATE FOR STACKS AND FOR CARD EDITS
    String PREF_SV_String_SelectedStack = "pref_sv_Shelf_Key-QnAE&4^j%6dMrs[4_HoldsASelectedClass";
    String PREF_SV_String_SelectedCardPosition = "pref_sv_Shelf_Key-QnAE&4^j%6dMrs[4_HoldsPositionForSelectedClass";
